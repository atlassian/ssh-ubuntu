...
import com.atlassian.performance.tools.sshubuntu.Ryuk
...
/**
 * Creates ssh container with open SSH port.
 *
...
class SshUbuntu(
    ...
    internal companion object {
        ...
        private const val SSH_USERNAME = "root"
        private const val SSH_PASSWORD = "root"
    }
    ...
    fun run(
        ...
        val sshUbuntuContainer =  GenericContainerImpl("rastasheep/ubuntu-sshd:18.04")
...
private class GenericContainerImpl(dockerImageName: String) : GenericContainer<GenericContainerImpl>(dockerImageName) {
    override fun getLivenessCheckPortNumbers(): Set<Int> {
        return setOf(getMappedPort(SshUbuntu.SSH_PORT))
    }
}